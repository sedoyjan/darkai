export default function Terms() {
  return (
    <div className="flex flex-col">
      ...
      <br />
      <p>
        These terms and conditions apply to the Dark AI app (hereby referred to
        as "Application") for mobile devices that was created by Sergei Grigorev
      ...
      <br />
      <p>These terms and conditions are effective as of 2025-04-09</p>
      <br />
